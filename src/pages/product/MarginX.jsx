    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-6 text-white">Testimonials</div>
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-6 text-white">Benchmarks & results</div>
        </div>
      </section>
