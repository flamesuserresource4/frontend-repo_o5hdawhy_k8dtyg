...
const features = ['Loan Origination','Pricing & Exposure','Risk Engine','Regulatory Compliance','Trader/Back Office Portals']

export default function MarginX() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <Hero
        title="Margin-X"
        subtitle="Automated margin trading, risk and compliance for capital markets"
      ...
      <section className="mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-white p-6 text-slate-900 shadow-sm">Testimonials</div>
          <div className="rounded-xl border border-slate-200 bg-white p-6 text-slate-900 shadow-sm">Benchmarks & results</div>
        </div>
      </section>
