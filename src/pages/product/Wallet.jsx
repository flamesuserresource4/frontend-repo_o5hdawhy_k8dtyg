...
const modules = ['Customer Wallet','Merchant Wallet','P2P','QR Payments','Bill Payments','Loyalty & Rewards','KYC Onboarding']
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Hero
        ...
        subtitle="Bank-grade wallet infrastructure for digital first experiences"
      ...
      <section className="mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-dashed border-slate-300 p-8 text-center text-slate-500">User Journey Diagram</div>
          <div className="rounded-xl border border-slate-200 bg-white p-6 text-slate-900 shadow-sm">Tech Stack Overview</div>
        </div>
      </section>
