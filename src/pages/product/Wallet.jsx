    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-dashed border-white/15 p-8 text-center text-slate-400">User Journey Diagram</div>
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-6 text-white">Tech Stack Overview</div>
        </div>
      </section>
